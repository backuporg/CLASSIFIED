...
public class BlockGrapeVineTrunk extends BlockGrapeVineBase
{
	public BlockGrapeVineTrunk()
	{
		super();
		...
		setUnlocalizedName("grc.grape_vine_trunk");
		setCreativeTab(null);
	}
	...
	{
		GrowthCraftGrapes.getLogger().warn("BlockGrapeVineTrunk#canUpdateGrowth TODO");
	...
	public void grow(World world, Random rand, BlockPos pos, IBlockState state)
	{
		...
		if (meta == 0 && world.isAirBlock(pos.up()))
		{
			...
			{
				incrementGrowth(world, pos, state);
				world.setBlockState(pos.up(), GrowthCraftGrapes.blocks.grapeVineTrunk.getBlock().getDefaultState(), BlockFlags.ALL);
			}
		}
